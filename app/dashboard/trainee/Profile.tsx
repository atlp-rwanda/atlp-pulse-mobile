    ...
    <>
      <View className="flex-1 ">
        <>
          ...
          <View className="flex-row justify-center items-center p-1 gap-3 w-[100%] mt-4 mb-3">
            {type.map((tabType, index) => (
              <Pressable
                key={index}
                onPress={() => handleTypeChange(tabType)}
                className={`px-4 py-3 border-b-2 border-action-500 items-center shadow-s shadow-action-500 justify-center rounded-lg
