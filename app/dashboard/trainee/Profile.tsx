...
// Access profile data after userToken is available
          ...
          <>
            <View className={`${bgColor} h-[38%] w-[100%] p-6 rounded-md `}>
              ...
              <View className="flex-row gap-5 m-2 ">
                ...
                <Text className={`${textColor} text-lg`}>
                  {/* {data.getProfile?.email ? data.getProfile?.email : 'Unavailable'} */}
                </Text>
              </View>
              <View className="flex-row gap-5 m-2 ">
                {colorScheme === 'dark' ? (
                ...
                <Text className={`${textColor} text-lg`}>
                  {/* {data.getProfile?.phoneNumber ? data.getProfile?.phoneNumber : 'Unavailable'} */}
                </Text>
              </View>
              <View className="flex-row gap-5 m-2 ">
                {colorScheme === 'dark' ? (
                ...
                <Text className={`${textColor} text-lg`}>
                  {/* {data.getProfile?.address ? data.getProfile?.address : 'Unavailable'} */}
                </Text>
              </View>
              <View className="flex-row gap-5 m-2 ">
                {colorScheme === 'dark' ? (
                ...
                <Text className={`${textColor} text-lg`}>
                  {/* {data.getProfile?.resume ? data.getProfile?.resume : 'Unavailable'} */}
                </Text>
              </View>

              <Text className={`${textColor} text-xl `}>RESUME</Text>
              <Text className={`${textColor} text-md m-2 `}>
                {/* {data.getProfile?.resume ? data.getProfile?.resume : 'No Resume uploaded yet'} */}
              </Text>
            </View>
